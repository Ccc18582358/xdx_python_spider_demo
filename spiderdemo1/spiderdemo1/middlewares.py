...
class Spiderdemo1SpiderMiddleware:
...
class Spiderdemo1DownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ChangeProxy(object):
    ...
    def __init__(self):
        self.get_url = "http://webapi.http.zhimacangku.com/getip?num=10&type=2&pro=&city=0&yys=0&port=1&time=1&ts=0&ys=0&cs=0&lb=1&sb=0&pb=4&mr=1&regions="
